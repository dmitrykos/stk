...
void PlatformX86Win32::Initialize(const IMemory &ctx_memory, IEventHandler *event_handler, uint32_t resolution_us,
    Stack *exit_trap)
{
...
{
    if ((g_Context == NULL) || (g_Context->m_overrider == NULL) || !g_Context->m_overrider->OnHardFault())
    {
